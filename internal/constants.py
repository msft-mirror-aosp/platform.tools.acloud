...
ENV_ANDROID_HOST_OUT = "ANDROID_SOONG_HOST_OUT"
# TODO(b/172535794): Remove the deprecated environment variable in the future.
ENV_SECOND_ANDROID_HOST_OUT = "ANDROID_HOST_OUT"
